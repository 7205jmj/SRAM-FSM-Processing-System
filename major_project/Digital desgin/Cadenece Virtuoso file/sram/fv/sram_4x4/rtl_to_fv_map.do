...
# Generated on: Mon Sep 07 16:13:55 IST 2026 (Mon Sep 07 10:43:55 UTC 2026)
...
set logfile fv/sram_4x4/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/sram_4x4 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  sram_4x4.v
elaborate_design -golden -root {sram_4x4} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/sram_4x4/fv_map.v.gz
elaborate_design -revised -root {sram_4x4}
...
add_black_box sram_cell -golden
...
set_system_mode lec
write_compared_points noneq.compared_points.sram_4x4.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.sram_4x4.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.sram_4x4.rtl.fv_map.rpt
