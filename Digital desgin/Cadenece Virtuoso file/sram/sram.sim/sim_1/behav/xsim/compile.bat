...
REM
REM Generated by Vivado on Mon Sep 07 15:29:53 +0530 2026
...
echo "xvlog --incr --relax -prj tb_sram_4x4_vlog.prj"
call xvlog  --incr --relax -prj tb_sram_4x4_vlog.prj -log xvlog.log
